    ...
    public class EmpdbRepository
    {
...

        {
            ...
            using (SqlConnection cn = SqlHelper.CreateConnection())
            {
                ...
                String selectAllEmps = "Select * from testdb_Sathwik";
        ...
        
        {
            ...
            using (SqlConnection cn = SqlHelper.CreateConnection())
            {
                ...
                SqlCommand selectempcmd = cn.CreateCommand();
                String selectAllEmps = "Select * from testdb_Sathwik Where eno=@id";   // @ is parameter
        ...
        public static int AddNewEmp(Emp newEmp) 
        {
            ...
            using (SqlConnection cn = SqlHelper.CreateConnection())
            {
                ...
                String insertNewEmpQuery = "insert into testdb_Sathwik values( @id,@name,@salary,@city )";
        ...
        
        {
            ...
            using (SqlConnection cn = SqlHelper.CreateConnection())
            {
                ...
                String updateEmpQuery = "Update testdb_Sathwik set name=@name, salary=@salary, city=@city where eno=@id";
        ...
        
        {
            ...
            using (SqlConnection cn = SqlHelper.CreateConnection())
            {
                ...
                String deleteEmpQuery = "Delete from testdb_Sathwik where eno=@id";
