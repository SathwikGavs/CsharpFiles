...
namespace ProjectD.Day3
{
    internal class StringLessons
    {
        ...
        public static void DemoD() 
        {
            ...
            Console.WriteLine("firstString: "+ firstString);
            Console.WriteLine("stringInlowe: " + stringInlower);
        ...
        {
            String letter = "Sir,\n As I am enjoying my life {4} , I want leave the companay permently. So, Noticing before {3} days,\n from {1} to {2}.\n\n Thank You \n {0}";



            String reason = "with my girl";
            String myName = "Sathwik";
            String no_of_Days = "4";
        ...
        internal static void DemoAExceptions()
        {
